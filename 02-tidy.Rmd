...
* `duplicated()`: Indicate which rows are duplicates of another row.
...
* `rownames`: Tools for working with row names.
        + `rowid_to_column()`: Add a column with row IDs.
            + This is useful when an separate ID is needed to manipulating rows or columns.
